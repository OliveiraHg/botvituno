...
const banner = cfonts.render(('VITUNO-MD'), {
    font: 'block',
    align: 'center',
...
const banner2 = cfonts.render(('By: - godvitinmodz - '), {
    font: 'chrome',
    align: 'center',
...
const banner3 = cfonts.render((`VITUNO-MD`), {
font: 'simple',
color: 'system',
align: 'center',
colors: [`${cor1}`,`${cor3}`,`${cor4}`,`${cor2}`],
...
authorname = 'VITUNO-BOT'
packname = '-JR-'
  
function addMetadata(packname, author) {	
if (!packname) packname = 'VITUNO-BOT'; if (!author) author = 'godvitinmodz';	
